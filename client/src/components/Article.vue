  ...
  div(class="wrapper")
    ...
    div(class="main-article" v-if="thisArticle")
      ...
      p(class="share-buttons")
        a(:href="'mailto:?subject=' + thisArticle.title + '&body=https://alf-israel.com/article' + thisArticle._id")
          i(class="fa fa-envelope-o top-icon" aria-hidden="true")
        a(class="fb-xfbml-parse-ignore" target="_blank" 
        :href="'https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Falf-israel.com%2Farticle%2F&amp;src=sdkpreparse' + thisArticle._id + '&amp;src=sdkpreparse'")
          i(class="fa fa-facebook-square top-facebook-icon top-icon" aria-hidden="true")
        a(v-if="this.screenWidth < 700" :href="'whatsapp://send?text=https://alf-israel.com/article/' + thisArticle._id" data-action="share/whatsapp/share" target="_blank")
          i(class="fa fa-whatsapp top-icon" aria-hidden="true")
        a(v-else :href="'https://web.whatsapp.com/send?text=https://alf-israel.com/article/' + thisArticle._id" data-action="share/whatsapp/share" target="_blank")
          i(class="fa fa-whatsapp top-icon" aria-hidden="true")
      ...
      div(class="dropdown-share btn-group")
        ...
        div(class="dropdown-menu")
          a(class="dropdown-item" :href="'mailto:?subject=' + thisArticle.title + '&body=https://alf-israel.com/article' + thisArticle._id")
          ...
          a(v-if="this.screenWidth < 700" class="dropdown-item" :href="'whatsapp://send?text=https://alf-israel.com/article/' + thisArticle._id" data-action="share/whatsapp/share" target="_blank")
            i(class="fa fa-whatsapp bottom-icon" aria-hidden="true")
          a(v-else class="dropdown-item" :href="'https://web.whatsapp.com/send?text=https://alf-israel.com/article/' + thisArticle._id" data-action="share/whatsapp/share" target="_blank")
            i(class="fa fa-whatsapp bottom-icon" aria-hidden="true")
</template>
